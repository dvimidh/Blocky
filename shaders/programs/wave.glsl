...
pos.y += 0.03*sin(0.06*worldTime + 0.25*pos.z - 0.45*pos.x + 10) * sin(0.06*worldTime + 0.05*pos.z + 0.05*pos.x + 10)
      ...
      +0.03*sin(0.04*worldTime + 1.0*pos.z - 0.7*pos.x + 11) * sin(0.04*worldTime + 0.04*pos.z + 0.06*pos.x + 11)
      + 0.03*sin(0.035*worldTime + 0.8*pos.z + 0.9*pos.x + 7)  * sin(0.035*worldTime + 0.04*pos.z - 0.06*pos.x + 7)
